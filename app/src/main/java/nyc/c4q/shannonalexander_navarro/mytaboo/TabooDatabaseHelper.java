...
public class TabooDatabaseHelper  extends  SQLiteOpenHelper{
        private static final String DATABASE_NAME = "taboo.db";
        private static final int DATABASE_VERSION = 2;

        // make your database instance a singleton instance across the entire application's lifecycle.
        private static TabooDatabaseHelper instance;
        ...
        public static synchronized TabooDatabaseHelper getInstance(Context context) {

            // Use the application context, which will ensure that you
            // don't accidentally leak an Activity's context.
            if (instance == null) {
                instance = new TabooDatabaseHelper(context.getApplicationContext());
            }
            return instance;
        }

        private TabooDatabaseHelper(Context context) {
            super(context, DATABASE_NAME, null, DATABASE_VERSION);
        }

        static {
            // register our models
            cupboard().register(TabooCard.class);
        }
